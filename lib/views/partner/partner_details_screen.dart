...
class _PartnerDetailsScreenState extends State<PartnerDetailsScreen> {
  ...
  void didChangeDependencies() {
    ...
    /// Screen open hote hi partner ko select karo
    /// aur API se fresh data laa lo
    if (!_initialized) {
  ...
  /// TAB CONTENT
  /// =========================================
  Widget _buildTabContent(PartnerAuth vm, PartnerModel partner) {
          ...
          Wrap(
            ...
            children: [
              ...
              _imageCard(
                ...
                imageUrl: partner.policeVerificationImage,
              ),
